...
windowwidth = 1000
windowheight = 500
rectX = 20.0	#X coordinate of the shape
rectY = 20.0	#Y coordinate of the shape
rectEndX = 30	#X coordinate of the end of the shape
rectEndY = 30	#X coordinate of the end of the shape
xdirection = 1
ydirection = 1
...
# Keyboard Variables
up = False    #default to false since the player hasn't done these actions yet
down = False   #default to false since the player hasn't done these actions yet
